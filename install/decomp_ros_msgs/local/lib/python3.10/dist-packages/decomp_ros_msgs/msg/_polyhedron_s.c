...
bool decomp_ros_msgs__msg__polyhedron__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("decomp_ros_msgs.msg._polyhedron.Polyhedron", full_classname_dest, 42) == 0);
  }
  decomp_ros_msgs__msg__Polyhedron * ros_message = _ros_message;
  {  // points
  ...
  {  // normals
    ...
    if (!geometry_msgs__msg__Point__Sequence__init(&(ros_message->normals), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__Point__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__Point * dest = ros_message->normals.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Polyhedron */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("decomp_ros_msgs.msg._polyhedron");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Polyhedron");
