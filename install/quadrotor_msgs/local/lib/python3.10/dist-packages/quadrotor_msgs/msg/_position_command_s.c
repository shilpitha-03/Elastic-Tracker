...
bool quadrotor_msgs__msg__position_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._position_command.PositionCommand", full_classname_dest, 52) == 0);
  }
  quadrotor_msgs__msg__PositionCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // kx
    PyObject * field = PyObject_GetAttrString(_pymsg, "kx");
    if (!field) {
      return false;
    }
    {
  ...
  {  // trajectory_flag
    PyObject * field = PyObject_GetAttrString(_pymsg, "trajectory_flag");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->trajectory_flag = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PositionCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._position_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionCommand");
  ...
  {  // kx
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "kx");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->kx[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  {  // kv
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "kv");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // trajectory_flag
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->trajectory_flag);
    {
      int rc = PyObject_SetAttrString(_pymessage, "trajectory_flag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
