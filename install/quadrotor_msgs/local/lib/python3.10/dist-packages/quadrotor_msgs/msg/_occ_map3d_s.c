...
bool quadrotor_msgs__msg__occ_map3d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._occ_map3d.OccMap3d", full_classname_dest, 38) == 0);
  }
  quadrotor_msgs__msg__OccMap3d * ros_message = _ros_message;
  {  // header
  ...
  {  // size_x
    ...
    ros_message->size_x = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // size_y
    ...
    assert(PyLong_Check(field));
    ros_message->size_y = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // size_z
    PyObject * field = PyObject_GetAttrString(_pymsg, "size_z");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->size_z = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // offset_x
    ...
    assert(PyLong_Check(field));
    ros_message->offset_x = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // offset_y
    ...
    assert(PyLong_Check(field));
    ros_message->offset_y = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // offset_z
    ...
    assert(PyLong_Check(field));
    ros_message->offset_z = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of OccMap3d */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._occ_map3d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OccMap3d");
  ...
  {  // size_x
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->size_x);
    {
  ...
  {  // size_y
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->size_y);
    {
  ...
  {  // size_z
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->size_z);
    {
      int rc = PyObject_SetAttrString(_pymessage, "size_z", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // offset_x
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->offset_x);
    {
  ...
  {  // offset_y
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->offset_y);
    {
  ...
  {  // offset_z
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->offset_z);
    {
