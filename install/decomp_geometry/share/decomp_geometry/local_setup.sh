...
: ${AMENT_CURRENT_PREFIX:="/mpc/new/Elastic-Tracker/install/decomp_geometry"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/decomp_geometry/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/decomp_geometry/environment/path.sh"
