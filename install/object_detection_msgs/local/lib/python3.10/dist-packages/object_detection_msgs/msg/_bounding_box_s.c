...
bool object_detection_msgs__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_detection_msgs.msg._bounding_box.BoundingBox", full_classname_dest, 51) == 0);
  }
  object_detection_msgs__msg__BoundingBox * ros_message = _ros_message;
  {  // probability
...
PyObject * object_detection_msgs__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_detection_msgs.msg._bounding_box");
