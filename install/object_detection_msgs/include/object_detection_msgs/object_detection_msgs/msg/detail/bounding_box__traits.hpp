...
#ifndef OBJECT_DETECTION_MSGS__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
#define OBJECT_DETECTION_MSGS__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
...
inline void to_yaml(
  const object_detection_msgs::msg::BoundingBox & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const object_detection_msgs::msg::BoundingBox & msg)
{
  return object_detection_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<object_detection_msgs::msg::BoundingBox>()
{
  return "object_detection_msgs::msg::BoundingBox";
}

template<>
inline const char * name<object_detection_msgs::msg::BoundingBox>()
{
  return "object_detection_msgs/msg/BoundingBox";
}

template<>
struct has_fixed_size<object_detection_msgs::msg::BoundingBox>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<object_detection_msgs::msg::BoundingBox>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<object_detection_msgs::msg::BoundingBox>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OBJECT_DETECTION_MSGS__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
