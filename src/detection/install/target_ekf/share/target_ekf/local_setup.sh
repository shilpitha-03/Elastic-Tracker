...
: ${AMENT_CURRENT_PREFIX:="/mpc/new/Elastic-Tracker/src/detection/install/target_ekf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/target_ekf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/target_ekf/environment/path.sh"
